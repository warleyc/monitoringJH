...
var monitoringApp = angular.module('monitoringApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'monitoringAppUtils', 'pascalprecht.translate', 'truncate']);
